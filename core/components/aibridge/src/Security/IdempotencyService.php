...
final class IdempotencyService
{
    ...
    public function begin(string $key, string $principal, string $operation, string $requestHash, int $profileId = 0): array
    {
        $where=['profile_id'=>$profileId,'idempotency_key'=>$key,'principal_id'=>$principal,'operation'=>$operation];
    ...
    public function complete(string $key,string $principal,string $operation,array $response,int $profileId=0): void
    {
