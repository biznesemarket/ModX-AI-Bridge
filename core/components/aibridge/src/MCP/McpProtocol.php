...
final class McpProtocol
{
    ...
    public function initialize(array $clientInfo=[]): array { return ['protocolVersion'=>self::PROTOCOL_VERSION,'capabilities'=>['tools'=>['listChanged'=>false],'resources'=>['subscribe'=>false,'listChanged'=>false],'prompts'=>['listChanged'=>false]],'serverInfo'=>['name'=>'modx-ai-bridge','version'=>'0.1.2']]; }
