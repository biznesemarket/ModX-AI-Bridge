...
final class CurlHttpClient implements HttpClient {
 ...
 public function request(string $method,string $path,array $headers=[],?array $json=null): array {
  ...
  $h=['Accept: application/json','Authorization: Bearer '.$this->token,'Content-Type: application/json','User-Agent: modx-ai-bridge-sdk-php/0.11']; foreach($headers as $k=>$v)$h[]=$k.': '.$v;
