...
Status: **STABLE** — current release `0.2.0` (tag `v0.2.0`), superseding `0.1.3`, `0.1.2`, `0.1.1` and `0.1.0`.
Evidence: `docs/release/stable-status.md`, `docs/release/0.2.0.md`, `docs/release/0.1.3.md`,
`docs/release/0.1.2.md`, `docs/release/0.1.1.md`, `docs/release/0.1.0.md`,
`docs/testing/iteration-52-release-0.2.0.md`.
