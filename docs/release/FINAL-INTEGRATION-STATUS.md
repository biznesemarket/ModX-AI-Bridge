...
Status: **STABLE** — current release `0.9.2` (tag `v0.9.2`), superseding `0.9.1`, `0.9.0`, `0.8.0`, `0.7.1`,
`0.7.0`, `0.6.0`, `0.5.0`, `0.4.0`, `0.3.0`, `0.2.0`, `0.1.3`, `0.1.2`, `0.1.1` and `0.1.0`. Evidence:
`docs/release/stable-status.md`, `docs/release/0.9.2.md`, `docs/release/0.9.1.md`, `docs/release/0.9.0.md`,
...
`docs/testing/iteration-63-security-hardening.md`.
